      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <video
            ...
            loop
            playsInline
            className="h-full w-full object-cover brightness-[1.22] saturate-[1.1]"
          >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/78 via-slate-950/42 to-blue-950/18" />
        <div className="absolute inset-0 bg-gradient-to-b from-slate-950/26 via-transparent to-slate-950/72" />
        ...
        <div className="relative mx-auto flex min-h-[88vh] max-w-7xl items-center px-6 py-20 lg:px-10 lg:py-28">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-8 max-w-4xl text-4xl font-semibold leading-[0.98] tracking-[-0.04em] text-white sm:text-5xl lg:text-[6.5rem]">
              {t.hero.title}
            </h1>

            <p className="mt-8 max-w-3xl text-base leading-8 text-white/82 sm:text-lg">
              {t.hero.subtitle}
            </p>
